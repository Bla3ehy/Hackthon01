...
namespace 生命靈數
{
    class Class1
    {
        public static Dictionary<int, string> CreateAries()
        {
        ...
        public static Dictionary<int, string> CreateTaurus()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int, string> CreateGemini()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int, string> CreateCancer()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int, string> CreateLeo()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int, string> CreateVirgo()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int, string> CreateLibra()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int,string> CreateScorpio()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int,string> CreateSagittarius()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int,string> CreateCapricorn()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int,string> CreateAquarius()
        {
            var result = new Dictionary<int, string>();
        ...
        public static Dictionary<int,string> CreatePieces()
        {
            var result = new Dictionary<int, string>();
